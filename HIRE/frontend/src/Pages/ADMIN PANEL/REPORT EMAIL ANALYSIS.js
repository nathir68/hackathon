...
const ReportEmailAnalysis = () => (
    <DashboardLayout sidebarLinks={adminLinks} userName={(JSON.parse(localStorage.getItem("hire_user")||'{"name":"Admin"}').name)} userRole="Administrator">
        <div className="page-wrapper">
            <div className="page-header"><h1>Report Email Analysis</h1><p>Analyze email campaign reports</p></div>
...
export default ReportEmailAnalysis;
